...
const Foot = () => {
  return (
    <div>
        <div data-scroll-section className=' bg-[#cdea68] w-full h-screen text-black  flex'>
        <div className='left w-1/2 h-full p-20 flex flex-col justify-between ' >
        <div><h1 className='text-[5vw] mb-[2vh] font-bold tracking-tighter'>EYE-</h1>
            <h1 className='text-[5vw] mb-[2vh] font-bold tracking-tighter'>OPENING</h1>
            </div>
        ...
        <div className='left w-1/2 h-full p-20   ' >
            <div className='flex flex-col gap-[5vh]'>
                <h1 className='text-[5vw] mb-[2vh] font-bold tracking-tighter'>PRESENTATION</h1>
